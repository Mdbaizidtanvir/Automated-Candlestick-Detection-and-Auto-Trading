...
# Cooldown higher and lower click periods
...
def click_with_shift_d(x, y):
    ...
    pyautogui.click(1806, 348)  # Click at coordinates (1803, 328)
    time.sleep(0.3)  # 5-second cooldown
    pyautogui.click(1316, 553)  # Click at coordinates (1317, 529)
...
def main_app():
    global last_click_time_higher, last_click_time_lower, last_shift_tab_time
    ...
    while True:
        ...
        if match_skip:
            ...
            # Check if it's been 2 seconds since the skip image was detected
